...
| **Issues** | Technical trade-offs (performance, compatibility, learning curve) | Competing systemic demands (governance vs openness, flexibility vs consistency) | Competing design demands (simplicity vs power, cultural specificity vs generality, progressive disclosure vs discoverability) | Competing human and procedural demands (trust vs efficiency, inclusivity vs pace, sustainability vs innovation) |
| **Motivating Example** | A real project that hit these technical trade-offs | A real project that faced these structural pressures | A real project where these design pressures emerged | A real project where these workflow/engagement challenges arose |
